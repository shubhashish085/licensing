                ...
                <div class="container pd-x-0">
                  <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                    ...
                    <div>
                      ...
                      <h4 class="mg-b-0 tx-spacing--1">List of all Clients</h4>
                    </div>
                    <div class="d-none d-md-block">
                      <a href="${contextPath}/license/details/edit" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"><i class="icon ion-md-add wd-10 mg-r-5"></i> Add New Client</a>
                    </div>
                      ...
                      <tbody>
                            <c:forEach items="${data}" var="entry">
                                <tr>
                                    ...
                                    <td>${entry.endDate}</td>
                                    <td>
                                        <a href = "<c:url value = "/license/details/view?id=${entry.oid}"/>">View</a> | <a href = "<c:url value = "/license/details/edit?id=${entry.oid}"/>">Edit</a>
                                    </td>
                                </tr>
                            </c:forEach>
